...
export const translations = {
    en: {
      ...
      hero: {
        ...
        subtitle: "Connect with experienced developers for personalized 1-on-1 sessions, code reviews, and career guidance",
      ...
      expertForm: {
        ...
        subtitle: "Share your expertise and help others grow while building your professional network",
        firstName: "First Name",
        lastName: "Last Name",
        email: "Email",
      ...
      talent: {
        ...
        subtitle: "Being registered as a talent will allow you to connect with other professionals in the industry",
    ...
    fr: {
      ...
      hero: {
        ...
        subtitle: "Connectez-vous avec des développeurs expérimentés pour des sessions personnalisées, des revues de code et des conseils de carrière",
      ...
      features: {
        ...
        live: {
          ...
          description: "Obtenez de l'aide en temps réel avec votre code via la programmation en binôme"
        },
        video: {
      ...
      expertForm: {
        ...
        subtitle: "Partagez votre expertise et aidez les autres à progresser tout en développant votre réseau professionnel",
        firstName: "Prénom",
        lastName: "Nom",
        email: "Email",
        ...
        bioPlaceholder: "Parlez-nous de votre expérience et de ce qui fait de vous un excellent mentor",
        cv: "Télécharger CV",
